-- 0065 — project_stats: łączną sumę godzin projektu (wszyscy) zwracamy TYLKO
-- uprawnionym (admin lub flaga hours_view_all). Pracownicy nie widzą sumy
-- godzin na projektach — również na poziomie danych, nie tylko w UI.
-- Reszta (osoby dziś, klient) bez zmian — z nich pracownik nadal korzysta.
...
as $function$
  select p.id as project_id,
         case when public.is_admin() or public.has_perm('hours_view_all')
